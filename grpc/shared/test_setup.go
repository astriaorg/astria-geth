...
func SetupSharedService(t *testing.T, noOfBlocksToGenerate int) (*eth.Ethereum, *SharedServiceContainer, ed25519.PrivateKey, ed25519.PublicKey) {
	t.Helper()
	genesis, blocks, bridgeAddress, feeCollectorKey, trustedBuilderPrivkey, trustedBuilderPubKey := GenerateMergeChain(noOfBlocksToGenerate, true)
	...
	return ethservice, sharedService, trustedBuilderPrivkey, trustedBuilderPubKey
}
