...
func testSetupGenesis(t *testing.T, scheme string) {
	var (
		...
		customg     = Genesis{
			Config: &params.ChainConfig{HomesteadBlock: big.NewInt(3), AstriaConfig: new(params.AstriaChainConfig)},
			Alloc: GenesisAlloc{
	...
	oldcustomg.Config = &params.ChainConfig{HomesteadBlock: big.NewInt(2), AstriaConfig: new(params.AstriaChainConfig)}
